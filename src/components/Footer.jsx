...
const Footer = () => {
  return (
    <footer className=" text-gray-700">
      <div className="px-4 py-8 sm:px-6 lg:px-8 max-w-[960px] mx-auto">
        <div className="text-center mb-14">
          <h1 className="text-2xl font-semibold">
            Discover{" "}
            <LocationMarkerIcon className="inline h-6 w-6 text-[#c5d447]" />a
            place <HomeIcon className="inline h-6 w-6 text-[#cab9fa]" />
            you’ll love <HeartIcon className="inline h-6 w-6 text-red-500" />
            to live
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            <h2 className="text-[16px] font-semibold mb-4">Popular Searches</h2>
            <ul className="space-y-1 text-[12px]">
              <li>Houses for Rent Near Me</li>
              <li>Houses for Sale Near Me by Owner</li>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-4">Explore Trulia</h2>
            <ul className="space-y-1 text-[12px]">
              ...
              <li className="flex font-[600] items-center text-[#007882] cursor-pointer ">
                <DotsHorizontalIcon className="h-3 w-3 mr-2" />
                More...
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 text-[12px]">
          <p className="font-[700]">
            ...
            (Canada) Inc. holds real estate brokerage{" "}
            <spna className="mt-2 underline font-[500] cursor-pointer text-[12px] text-[#007882]">
              licenses
            </spna>{" "}
            in multiple provinces.
          </p>
          <p>
            <span className="mt-2 underline font-[500] cursor-pointer text-[12px] text-[#007882]">
              § 442-H New York Standard Operating Procedures <br /> New York
              Fair Housing Notice
            </span>{" "}
            <br /> TREC:{" "}
            <span className="mt-2 underline font-[500] cursor-pointer text-[12px] text-[#007882]">
          ...
          <p>
            <span className="mt-2 font-[500] cursor-pointer text-[12px] text-[#007882]"></span>{" "}
            California DRE #1522444
          </p>
          <p>
            <span className="mt-2 underline font-[700] cursor-pointer text-[12px] text-[#007882]">
              {" "}
        ...
        <div className="mt-4 text-[12px]">
          <ul className="inline">
            ...
            <li className="inline-block relative ml-2">
              <p className="mt-2 font-[500] cursor-pointer text-[12px] text-[#007882]">
                <b> Do Not Sell or Share My Personal Information &rarr;</b>
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className="mt-4 text-[12px]">
          <ul className="inline">
            ...
            <li className="inline-block relative ml-2">
              <p className="mt-2 font-[700] cursor-pointer text-[12px] text-[#007882]">
                <b> Do Not Sell or Share My Personal Information &rarr;</b>
              </p>
            </li>
          </ul>
        ...
        <div className="mt-8 text-[12px]">
          <p>
            ...
            an issue or seek an accommodation, please let us know.
          </p>
          <p className="mt-4 text-[10px]">
            Copyright © 2024 Trulia, LLC. All rights reserved. Equal Housing
      ...
      <div class="max-w-[704px] max-h-[113px] my-[0px] mx-auto large:py-[0px ImageContainer">
        <svg
          width="100%"
          height="100%"
          viewBox="0 0 704 113"
